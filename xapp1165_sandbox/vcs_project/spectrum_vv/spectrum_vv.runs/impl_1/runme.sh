...
HD_PWD=/media/Data/Work/adder_tb_vivado/xapp/vcs_project/spectrum_vv/spectrum_vv.runs/impl_1
cd "$HD_PWD"
...
EAStep vivado -log spectrum_top.vdi -applog -m64 -messageDb vivado.pb -mode batch -source spectrum_top.tcl -notrace
