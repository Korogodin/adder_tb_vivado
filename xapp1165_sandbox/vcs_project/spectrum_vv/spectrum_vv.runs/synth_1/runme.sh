...
HD_PWD=/media/Data/Work/adder_tb_vivado/xapp/vcs_project/spectrum_vv/spectrum_vv.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log spectrum_top.vds -m64 -mode batch -messageDb vivado.pb -notrace -source spectrum_top.tcl
